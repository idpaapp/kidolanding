...
export function HeroSection({ data }: HeroSectionProps) {
  ...
  // Decorative elements for background - further reduced for better performance
  const decorativeElements = [
    // Clouds - reduced to 4 for better performance
    { type: 'cloud', x: '5%', y: '8%', size: 'w-24 h-18 md:w-32 md:h-24', color: 'pastel-pink', rotate: 0 },
    { type: 'cloud', x: '85%', y: '12%', size: 'w-28 h-20 md:w-36 md:h-26', color: 'pastel-blue', rotate: 5 },
    { type: 'cloud', x: '15%', y: '65%', size: 'w-22 h-16 md:w-30 md:h-22', color: 'pastel-yellow', rotate: -3 },
    { type: 'cloud', x: '75%', y: '75%', size: 'w-20 h-15 md:w-28 md:h-20', color: 'pastel-purple', rotate: 8 },
    // Stars - reduced to 4
    { type: 'star', x: '12%', y: '22%', size: 'w-12 h-12 md:w-16 md:h-16', color: 'pastel-yellow', rotate: 15 },
    { type: 'star', x: '72%', y: '28%', size: 'w-10 h-10 md:w-14 md:h-14', color: 'pastel-pink', rotate: 30 },
    { type: 'star', x: '28%', y: '82%', size: 'w-14 h-14 md:w-18 md:h-18', color: 'pastel-orange', rotate: 45 },
    { type: 'star', x: '82%', y: '62%', size: 'w-11 h-11 md:w-15 md:h-15', color: 'pastel-purple', rotate: 20 },
    // Balloons - reduced to 3
    { type: 'balloon', x: '12%', y: '30%', size: 'w-16 h-20 md:w-20 md:h-24', color: 'pastel-pink', rotate: -10 },
    { type: 'balloon', x: '88%', y: '25%', size: 'w-14 h-18 md:w-18 md:h-22', color: 'pastel-blue', rotate: 8 },
    { type: 'balloon', x: '50%', y: '12%', size: 'w-14 h-18 md:w-18 md:h-22', color: 'pastel-cyan', rotate: -8 },
  ];
  ...
  return (
    ...
    >
      ...
      {/* Reduced animations for better performance - only animate on initial load */}
